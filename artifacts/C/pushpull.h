...
extern void pullg(float *g1, const float *phi, const float *f0,
                  const USIZE_t *d0, const USIZE_t n1, const int *bnd, const USIZE_t *dp, const int ext);
extern void pull_affine(float *f1, const float *f0, const USIZE_t *d0, const USIZE_t n1,
                         const USIZE_t *d1, const float *Aff, const int *bnd, const USIZE_t *dp, const int ext);
extern void push_affine(float *f0, const float *f1, const USIZE_t *d0, const USIZE_t n1,
                        const USIZE_t *d1, const float *Aff, const int *bnd, const USIZE_t *dp, const int ext);
/*
