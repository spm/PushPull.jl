...
function TVdenoise(x::Union{AbstractArray{Float32,3},AbstractArray{Float32,4}}, nit::Integer=1, vox::NTuple{3,Real}=(1.0f0,1.0f0,1.0f0), lambda::Union{Real,Array{Real}}=1.0f0)
    y = deepcopy(x)
